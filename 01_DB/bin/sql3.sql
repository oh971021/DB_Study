...
insert into snack values (snack_seq.nextval, '꽃게랑', '롯데', 20, 1100, sysdate);
insert into snack values (snack_seq.nextval, '감자깡', '롯데', 50, 1100, sysdate);
...
insert into snack values (snack_seq.nextval, '롯데빼빼로', '해태', 50, 1300, sysdate);
insert into snack values (snack_seq.nextval, '누드빼빼로', '해태', 50, 1400, sysdate);
